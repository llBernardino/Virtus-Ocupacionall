        ...
        <BackgroundBlog> 
          <Container maxWidth='lg'>
            ...
            <Grid container textAlign='center' justifyContent='center' alignItems='start'>
              <Grid sm={12} md={4} lg={4} display='flex' alignItems='center' p={2} flexDirection = 'column' justifyContent='center' >
              ...
              <Grid sm={12} md={12} lg={4} display='flex' alignItems='center' p={2} flexDirection = 'column' justifyContent='center' >
              ...
              <Grid sm={12} md={8} lg={4} display='flex' alignItems='center' p={2} flexDirection = 'column' justifyContent='center' >
