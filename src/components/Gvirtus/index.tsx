    ...
    return ( 
      <BackgroundGvirtus> 
        <Container maxWidth='lg'>
          ...
          <Grid container spacing={2} textAlign='center' justifyContent='center' alignItems='start' className='animation'>
            ...
            <Grid sm={12} md={12} lg={4} display='flex' alignItems='ceter' p={2} flexDirection = 'column' justifyContent='center' className='select' >
            ...
            <Grid sm={12} md={8} lg={4} display='flex' alignItems='ceter' p={2} flexDirection = 'column' justifyContent='center' className='select' >
